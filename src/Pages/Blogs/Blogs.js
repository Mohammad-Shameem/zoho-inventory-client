  ...
  return (
    <div className=" container mb-5">
      <div className=" row gx-5 mt-5 ">
        <div className=" col-sm-12 col-md-4 mb-5 questions ">
          <h5>Q:- Difference between Node.JS and Javascript?</h5>
          <h6>
            1. NodeJS : NodeJS is a cross-platform and opensource Javascript
            runtime environment that allows <br />
            the javascript to be run on the server-side. Nodejs allows
        ...
        <div className=" col-sm-12 col-md-4 questions mb-5 ">
          <h5>Q:- When should you use nodejs and when should you use?</h5>
          <h6>
            1 Nodejs is a Javascript engine that you can write any application
            you want with <br />
            (by programming in the Javascript language). It runs your Javascript
            code. Most <br />
            commonly, it is used to build servers that can respond to web
            requests, though it <br />
            ...
            built with nodejs <br />
            that will then use MongoDB for storing data. <br />
            MongoDB offers an API library that runs within a Nodejs application
            to give you <br />
            ...
            API libraries for <br />
            other programming environments such as Python, Java, etc... <br />
            These two technologies are for different parts of a typical web
            server system.
            <br />
        ...
        <div className=" col-sm-12 col-md-4  questions  ">
