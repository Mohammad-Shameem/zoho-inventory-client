...
const Login = () => {
    ...
    const sendPaswordResetMail = async () => {
        ...
        if (error1) {
            ...
            toast("please atleast put your email into input field to get password reset link", {
                position: "top-center"
            })
        }
        ...
        <div >
            ...
            <div className='w-50 mx-auto mt-5 login-form'>
                <Form onSubmit={handleLogin}>
                    ...
                    <p>New Here ? <span ><Link to='/signup'>create a account</Link> </span></p>
                    <p>Forgot password ? <span onClick={sendPaswordResetMail} className='text-danger reset-text'>Reset Now !</span></p>
            ...
            >
                ...
                <h6 className='p-5'>your password reset mail has been sent. <br />
